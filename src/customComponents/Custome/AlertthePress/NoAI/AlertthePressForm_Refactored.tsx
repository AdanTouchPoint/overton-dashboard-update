...
import { initialContentStateAP, ContentStateAP } from "../../../../lib/contentStateAP"; // ESPECÍFICO DE AP
...
const AlertthePressFormRefactored: React.FC<APprops> = ({
  ...
  >(genericContentReducer, initialContentStateAP);

  useEffect(() => {
    if (mode === 'edit' && campaignEditData) {
      // Fusión profunda para asegurar que todos los campos tengan valor
      const mergedState = {
        ...initialContentStateAP,
        ...campaignEditData,
        projectData: {
          ...initialContentStateAP.projectData,
          ...(campaignEditData.projectData || {}),
        },
        style: {
          ...initialContentStateAP.style,
          ...(campaignEditData.style || {}),
        },
        mainform: {
          ...initialContentStateAP.mainform,
          ...(campaignEditData.mainform || {}),
        },
        email: {
            ...initialContentStateAP.email,
            ...(campaignEditData.email || {}),
        },
        emailreview: {
            ...initialContentStateAP.emailreview,
            ...(campaignEditData.emailreview || {}),
        },
        ty: {
            ...initialContentStateAP.ty,
            ...(campaignEditData.ty || {}),
        },
      };
...
export default AlertthePressFormRefactored;
