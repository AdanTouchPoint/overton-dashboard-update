...
import { ContentStateAP } from './contentStateAP';
...
export type ContentActionAP = UpdateContentAction;
...
export const contentReducerAP = (state: ContentStateAP, action: ContentActionAP): ContentStateAP => {
  switch (action.type) {
    case 'UPDATE_CONTENT':
